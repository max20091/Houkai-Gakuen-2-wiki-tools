...
FOR %%f in ("%CD%\1 2 icon\*.png") DO REN "%CD%\1 2 icon\*.png" "%file% %star% Stars icon.png"
FOR %%f in ("%CD%\1 3 pocket\*.png") DO REN "%CD%\1 3 pocket\*.png" "%file% %star% Stars pocket.png"
